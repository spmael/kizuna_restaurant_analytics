        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0,
                        help_text="Number of unique registered customers served",
                        verbose_name="Registered Customers",
                    ),
                ),
                (
                    "walk_in_customers",
                    models.PositiveIntegerField(
                        default=0,
                        help_text="Number of walk-in customers (each counted individually)",
                        verbose_name="Walk-in Customers",
                    ),
                ),
                (
                    "average_order_value",
