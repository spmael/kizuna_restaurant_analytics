        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "current_stock",
                    models.DecimalField(
                        decimal_places=2, max_digits=15, verbose_name="Stock"
                    ),
                ),
                (
                    "description",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quantity_sold",
                    models.DecimalField(
                        decimal_places=2, max_digits=15, verbose_name="Quantity Sold"
                    ),
                ),
                (
                    "unit_sale_price",
                ...
                (
                    "total_sale_price",
                    models.DecimalField(
                        decimal_places=2, max_digits=15, verbose_name="Total Sale Price"
                    ),
                ),
                (
                    "customer",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "total_cost",
                    models.DecimalField(
                        decimal_places=2, max_digits=15, verbose_name="Total Cost"
                    ),
                ),
                (
                    "created_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "source",
                    models.CharField(
                        help_text="e.g., Supplier, Market, Industry Standard",
                        max_length=200,
                        verbose_name="Source",
                    ),
                ),
            ...
            options={
                "verbose_name": "Market Price Reference",
                "verbose_name_plural": "Market Price References",
                "ordering": ["-effective_date", "product"],
                "indexes": [
                    models.Index(
                        fields=["product", "effective_date"],
                        name="restaurant__product_350ed7_idx",
                    ),
                    models.Index(
                        fields=["is_active"], name="restaurant__is_acti_0f3c71_idx"
                    ),
                ],
            },
        ),
